...
#define DYNAMIC_OFFSET			(0.0349066)//(0.0174533)//(+ 1.0)
#define I0						(0.03046)
#define I1						(0.03046)
#define O1						(0.9391)

/*static float Hd_IMU[] = {
	0.0141  ,  0.0300  ,  0.0720  ,  0.1245  ,  0.1674  ,  0.1838  ,  0.1674  ,  0.1245  ,  0.0720, 0.0300  ,  0.0141
};*/

static float Hd_IMU[] = {0.12, 0.7, 0.12};

#define SIZE_ANGLE				(3)

float angle_measure[SIZE_ANGLE];
